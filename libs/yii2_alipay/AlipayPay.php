...
class AlipayPay {
     ...
     */
    public $partner = '2088521151731703';
    ...
    /**
     * @var String 安全检验码，以数字和字母组成的32位字�?
     */
    public $key = 'csvvb55zfu6lecb40o4i9jwvl9hbkla9';
    ...
    /**
     * @var String 字符编码格式 目前支持 gbk �?utf-8
     */
     ...
     */
    public $notify_url = 'http://video.gmatonline.cn/index';

    /**
     * @var String 页面跳转同步通知页面路径
     * 需http://格式的完整路径，不能�?id=123这类自定义参数，不能写成http://localhost/
     */
    public $return_url = 'http://video.gmatonline.cn/index/return-url';
     ...
     */
    public function requestPay($out_trade_no, $subject, $total_fee, $body, $show_url,$service) {
        switch ($service) {
            case "wap" :
