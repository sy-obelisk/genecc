...
<head>
    ...
    <title>webplayer vod</title>
    <link rel="stylesheet" type="text/css" href="web_core/styles/css/common.css">
    <link rel="stylesheet" type="text/css" href="web_core/styles/css/jquery-ui-1.10.3.custom.gs.min.css">
    <link rel="stylesheet" type="text/css" href="web_core/styles/css/main.css">

    <script type="text/javascript" src="web_core/styles/js/jquery-1.9.1.min.js"></script>
    <script type="text/javascript" src="http://static.gensee.com/webcast/static/sdk/js/gssdk.js"></script>
    <script type="text/javascript" src="web_core/styles/js/json2.js"></script>
    <script type="text/javascript" src="web_core/styles/js/webplayer.common.js"></script>
    <script type="text/javascript" src="web_core/styles/js/webplayer.vod.js"></script>
    <script type="text/javascript" src="web_core/styles/js/jquery-ui-1.10.3.custom.min.js"></script>

    <!--[if IE 6]>
    <script type="text/javascript" src="web_core/styles/js/DD_belatedPNG.js"></script>
        ...
        <div class="outline-container">
            ...
            <div class="outline-main">
                <div class="classBottom">
                    <img src="/app/web_core/styles/images/gmat_live.png" alt="图片"/>
                    <ul>
                        <li>更多GMAT精品课程预告</li>
                        <li>1、留学名校免费规划评估</li>
                        <li>2、托福一对一定制课程</li>
