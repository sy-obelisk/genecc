                        ...
                        foreach($data as $k=>$v) {
                            ...
                            <li>
                                ...
                                <div class="aboutTBd-right">
                                    ...
                                    <p><?php echo $v['name']?></p>
                                    <a href="/cn/mall-two/290-<?php echo $v['id']?>.html">查看详情 &gt;</a>
                                </div>
            ...
            foreach($data as $v) {
                ...
                <div class="col-md-3">
                    <div class="open-commonStyle">
                        ...
                        <p><a href="/public-class/<?php echo $v['id']?>.html"><?php echo $v['name']?></p>
                ...
                <div class="dynamic-right">
                    ...
                    <ul>
                        ...
                        foreach($data as $v) {
                            ?>
                            <li>
                                <a href="/cn/dynamic/detail/243-<?php echo $v['id']?>.html"><?php echo $v['title']?></a>
                            </li>
                            <?php
                        }
                        ?>
