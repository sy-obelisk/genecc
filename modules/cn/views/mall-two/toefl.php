...
<div class="caseBorder">
    <div class="purple-title">
        <span>托福高分捷报</span>
        <a href="/cn/mall-two/list-289.html">MORE</a>
    </div>
    <div class="col-md-6">
        <div class="col-md-3">
            <div class="book-left">
            ...
            <div class="book-right">
                <ul>
                    ...
                    foreach($data as $v) {
                        ?>
                        <li>
                            <a href="/cn/mall-two/289-<?php echo $v['id']?>.html"><i>•</i><?php echo $v['name']?></a>
                        </li>
                        <?php
                    }
                    ?>
    ...
    <div class="caseBorder">
        <div class="purple-title">
            ...
            <a href="/cn/mall-two/list-290.html">MORE</a>
        </div>
        <div class="col-md-6">
            <div class="col-md-3">
                <div class="book-left">
                ...
                <div class="book-right">
                    <ul>
                        ...
                        foreach($data as $v) {
                            ?>
                            <li>
                                <a href="/cn/mall-two/290-<?php echo $v['id']?>.html"><i>•</i><?php echo $v['name']?></a>
                            </li>
                            <?php
                        }
                        ?>
                ...
                <div class="greyB-ul">
                    <ul>
                        ...
                        foreach($data as $v) {
                            ...
                            <li>
                                <i>•</i>
                                <a href="/cn/mall-two/268-<?php echo $v['id']?>.html"><?php echo $v['name']?></a>
                            </li>
                            <?php
                        }
                        ?>
