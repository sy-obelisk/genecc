...
<div class="synthesize">
    <ul>
        ...
        <li><a href="/voucher/category-<?php echo isset($_GET['category'])?$_GET['category']:0?>/page-<?php echo isset($_GET['page'])?$_GET['page']:1?>/time-<?php echo isset($_GET['time'])&&$_GET['time'] == 1?2:1?>.html">最新 <?php if(!isset($_GET['time'])){echo '';}elseif($_GET['time'] == 1){echo '<i class="fa  fa-long-arrow-down"></i>';}else{echo '<i class="fa  fa-long-arrow-up"></i>';}?></a></li>
    </ul>
</div>
<!--内容部分-->
        ...
        <ul>
            ...
            foreach($data as $v) {
                ...
                <li>
                    ...
                    <a href="/goods/<?php echo $v['id']?>.html">点击购买</a>
                    <a href="#">立即咨询</a>
                </li>
            <?php
            }
...
<script type="text/javascript">
    function clickClassify(){
        ...
        location.href ="/voucher/category-"+category+"/page-1"+".html"
    }
    ...
    $('.iPage').click(function(){
        ...
        location.href ="/voucher/category-<?php echo isset($_GET['category'])?$_GET['category']:0?>/page-"+page+str+".html";
    })
