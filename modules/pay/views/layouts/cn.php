...
<div class="greyNav">
    <div class="inGrey">
        <div class="leftNav">
            <ul>
                <li>
                    <img src="/cn/images/index_kevinIcon.png" alt="图标">
                </li>
    ...
    <div class="in_head">
        ...
        <div class="col-md-6">
            <div class="searchBox">
                ...
                <div class="col-md-7">
                    <input class="goodsKeywords" type="text" placeholder="美国本科" onkeydown="javascript:searchs(event)" value="<?php echo  isset($_GET['content'])?$_GET['content']:''?>"/>
                </div>
                <div class="col-md-2 search_K">
                    <span id="searchHtml">搜产品</span>
